...
mysql --user="root" --password="secret" -e "CREATE USER 'drinkaccounting'@'10.0.2.2' IDENTIFIED BY 'secret';"
mysql --user="root" --password="secret" -e "GRANT ALL ON *.* TO 'drinkaccounting'@'10.0.2.2' IDENTIFIED BY 'secret' WITH GRANT OPTION;"
mysql --user="root" --password="secret" -e "GRANT ALL ON *.* TO 'drinkaccounting'@'%' IDENTIFIED BY 'secret' WITH GRANT OPTION;"
